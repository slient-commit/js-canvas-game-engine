class InputManager {
    ...
    isKeyPressed(key) { return this._keysPressed.has(key); }

    /** Key was released this frame */
    isKeyReleased(key) { return this._keysReleased.has(key); }

    // --- Mouse ---

    /** Mouse button held down (0=left, 1=middle, 2=right) */
    isMouseDown(button) { return this._mouseDown.has(button !== undefined ? button : 0); }

    /** Mouse button pressed this frame */
    isMousePressed(button) { return this._mousePressed.has(button !== undefined ? button : 0); }

    /** Mouse button released this frame */
    isMouseReleased(button) { return this._mouseReleased.has(button !== undefined ? button : 0); }
